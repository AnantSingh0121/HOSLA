...
public class EmergencyCall extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        callText6 = findViewById(R.id.callTxt6);
        ...
        callBtn6 = findViewById(R.id.callButton6);
        callBtn7 = findViewById(R.id.callButton7);
        callBtn8 = findViewById(R.id.callButton8);
    ...
    private void CallButton() {
        ...
        if (number.trim().length() > 0) {
            if (ContextCompat.checkSelfPermission(EmergencyCall.this, Manifest.permission.CALL_PHONE) !=
